...
public class FXMLDocumentController implements Initializable  {
    ...
    return false;
       ...
       public void TransferVariable( ObservableList<Magazine> Magazines,ObservableList<Supplement> Supplements, ObservableList<Customer> Customers, ObservableList<AssociateCustomer> AssociateCustomers,  ObservableList<PayingCustomer> PayingCustomers){
           System.out.println("asd"+Supplements.get(0).getCost());
    ...
    public void initialize(URL url, ResourceBundle rb) {
       Supplements.add(new Supplement(1,"s1","17/08/2000",10));
       Supplements.add(new Supplement(2,"s2","17/08/2000",20));
       Supplements.add(new Supplement(3,"s3","17/08/2000",30));
       Supplements.add(new Supplement(4,"s4","17/08/2000",40));
       Supplements.add(new Supplement(5,"s5","17/08/2000",20));
       Supplements.add(new Supplement(6,"s6","17/08/2000",30));
       Supplements.add(new Supplement(7,"s7","17/08/2000",40));
       Customers.add(new Customer(1, "John", new Adress(5, 34410, "Loyal Street", "Hollywood"), "asd@gmail.com",Supplements));
       Customers.add(new Customer(2, "John1", new Adress(54, 344310, "Love Street", "Paris"), "asddsd@gmail.com",Supplements));
       Customers.add(new Customer(3, "John13", new Adress(34, 410, "Crazy Street", "asdd"), "sads@gmail.com",Supplements));
       PayingCustomer.add(new PayingCustomer(AssociateCustomer,4, "CreditCard", "Steven", new Adress(5, 34410, "Loyal Street", "Hollywood"), "123asdö@gmail.com", Supplements));
       AssociateCustomer.add(new AssociateCustomer(PayingCustomer.get(0), 5, "Archie", new Adress(34, 410, "Crazy Street", "asdd"), "bbb@gmail.com", Supplements));
       AssociateCustomer.add(new AssociateCustomer(PayingCustomer.get(0), 6, "Mark", new Adress(34, 4120, "Craziest Street", "asdsdsd"), "bbasd@gmail.com", Supplements));
        Customers.addAll(AssociateCustomer);
        Customers.addAll(PayingCustomer);
     
       
       Magazine mag = new Magazine(1,20,Supplements);
       Magazine.add(mag);
       try{
